...
public class AntidelmaRequests {
	...
	public boolean confirm( String url ) throws ClientProtocolException, IOException {
		MyCurler curl = new MyCurler();
		curl.prepareRequest( MyCurler.RequestTypes.GET, url );
		curl.setHeaders( new String[] { 
				"Host: www.extrastolowki.pl",
				"User-Agent: Mozilla/5.0 (Macintosh; Intel Mac OS X 10.11; rv:51.0) Gecko/20100101 Firefox/51.0",
				"Accept: */*",
		...
		if (result.toString().contains("kujemy za potwierdzenie")) {
